...
Se debe aceptar primero la actividad que termina primero (f(i) minimo). De esta manera se maximiza el tiempo que resta para satisfacer otros intervalos. Posteriormente, se itera aceptando aquellas que cumplan: s[i] >= f[m], donde m es el ultimo valor aceptado.
